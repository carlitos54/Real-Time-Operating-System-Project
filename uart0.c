...
{
    // Enable clocks
    SYSCTL_RCGCUART_R |= SYSCTL_RCGCUART_R0;            //enables clocks for Uart0
    SYSCTL_RCGCGPIO_R |= SYSCTL_RCGCGPIO_R0;            //enables clocks for port A where the Uarts pins are located
    _delay_cycles(3);
